...
#define SHUTTLE_FB_BPP			32				/* bits per pixel */
#define SHUTTLE_FB_HDMI_PAGES	2				/* At least, 2 video pages for HDMI */
#define SHUTTLE_FB_HDMI_BPP		32				/* bits per pixel */
...
/* Frame buffer size */
#	define SHUTTLE_FB_SIZE TEGRA_ROUND_ALLOC(1280*800*(SHUTTLE_FB_BPP/8)*SHUTTLE_FB_PAGES)
...
/* Frame buffer size */
#	define SHUTTLE_FB_SIZE TEGRA_ROUND_ALLOC(1368*768*(SHUTTLE_FB_BPP/8)*SHUTTLE_FB_PAGES)
#elif defined(SHUTTLE_1024x600PANEL1)
/* If using 1024x600 panel (Shuttle default panel) */
/* Frame buffer size */
#	define SHUTTLE_FB_SIZE TEGRA_ROUND_ALLOC(1024*600*(SHUTTLE_FB_BPP/8)*SHUTTLE_FB_PAGES)
#else
/* Frame buffer size */
#	define SHUTTLE_FB_SIZE TEGRA_ROUND_ALLOC(1024*600*(SHUTTLE_FB_BPP/8)*SHUTTLE_FB_PAGES)
#endif
...
/* Frame buffer size */
#	define SHUTTLE_FB_HDMI_SIZE TEGRA_ROUND_ALLOC(1920*1080*(SHUTTLE_FB_HDMI_BPP/8)*SHUTTLE_FB_PAGES)
#else
#	define SHUTTLE_FB_HDMI_SIZE TEGRA_ROUND_ALLOC(1280*720*(SHUTTLE_FB_HDMI_BPP/8)*SHUTTLE_FB_PAGES)
#endif
